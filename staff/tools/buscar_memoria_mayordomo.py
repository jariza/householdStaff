...
@tool
def buscar_memoria_mayordomo(texto_a_buscar: str, config: RunnableConfig, store: Annotated[BaseStore, InjectedStore()]) -> str:
    """Busca en la memoria a largo plazo del mayordomo."""

    user_id = config.get("configurable", {}).get("user_id")
    memory_namespace = (user_id, "butler")
