...
2. Dispones de una herramienta para buscar en la memoria: Si el contexto pre-cargado está vacío, es incompleto o genera dudas para responder con precisión, invoca la herramienta `buscar_memoria` reformulando la consulta con los términos más relevantes antes de dar una respuesta definitiva.
